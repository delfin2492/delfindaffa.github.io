      ...
      <div class="container">
       ...
       <div class="w-full px-4 mb-12 md:w-1/3">
          ...
          <ul class="text-slate-300">
            <li>
              <a href="Etourism.html" class="inline-block text-base hover:text-primary mb-3">Pengembangan Sektor E-Tourism</a>
            </li>
            <li>
              <a href="ekonomidigital.html" class="inline-block text-base hover:text-primary mb-3">Perkembangan Ekonomi Digital</a>
            </li>
            <li>
              <a href="transformasidigital.html" class="inline-block text-base hover:text-primary mb-3">Transformasi Digital di Indonesia</a>
            </li>
            <li>
              <a href="smarthome.html" class="inline-block text-base hover:text-primary mb-3">Smarthome Sederhana Berbasis IoT</a>
            </li>
            <li>
              <a href="gerbangotomatis.html" class="inline-block text-base hover:text-primary mb-3">Miniatur Gerbang Otomatis</a>
            </li>
          </ul>
      </div>
        <div class="w-full px-4 mb-12 md:w-1/3">
          ...
          <div class="w-full pt-10 border-t border-slate-700">
            <div class="flex items-center justify-center mb-5">
              ...
              <!-- Github -->
              <a href="https://github.com/delfin2492" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white ">
